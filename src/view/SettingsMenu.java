...
public class SettingsMenu extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        btnPrevious.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/btnPrevious.png"))); // NOI18N
        btnPrevious.setToolTipText("Vorige");
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        RoosterProgramma.getInstance().getSettings().setSettings(
        ...
        RoosterProgramma.getInstance().getSettings().save();
        RoosterProgramma.getInstance().setSettings(RoosterProgramma.getInstance().getSettings());
