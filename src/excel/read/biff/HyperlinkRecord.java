...
public class HyperlinkRecord extends RecordData implements Hyperlink
{
  ...
  HyperlinkRecord(Record t, Sheet s, WorkbookSettings ws)
  {
    ...
    if (linkType == urlLink)
    {
      ...
      {
        System.out.println("URL " + urlString + " is malformed.  Trying a file");
        try
        {
          linkType = fileLink;
        ...
        {
          System.out.println("Cannot set to file.  Setting a default URL");
    ...
    else if (linkType == fileLink)
    {
      ...
      {
        System.out.println("Exception when parsing file " + 
                    e.getClass().getName() + ".");
        file = new File(".");
      }
    }
    ...
    {
      // give up
      System.out.println("Cannot determine link type");
      return;
    }
  }
