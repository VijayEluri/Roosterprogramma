...
import excel.biff.formula.FormulaParser;
...
class ReadFormulaRecord extends CellValue implements FormulaData
{
  ...
  void columnInserted(Sheet s, int sheetIndex, int col)
  {
    ...
    {
      System.out.println("cannot insert column within formula:  " + e.getMessage());
    }
  }
  ...
  void columnRemoved(Sheet s, int sheetIndex, int col)
  {
    ...
    {
      System.out.println("cannot remove column within formula:  " + e.getMessage());
    }
  }
  ...
  void rowInserted(Sheet s, int sheetIndex, int row)
  {
    ...
    {
      System.out.println("cannot insert row within formula:  " + e.getMessage());
    }
  }
  ...
  void rowRemoved(Sheet s, int sheetIndex, int row)
  {
    ...
    {
      System.out.println("cannot remove row within formula:  " + e.getMessage());
    }
  }
                                              ...
                                              WorkbookSettings ws)
  {
    ...
    {
      System.out.println("cannot import formula:  " + e.getMessage());
      return false;
    }
  }
}
