...
import excel.biff.EncodedURLHelper;
...
class SupbookRecord extends WritableRecordData
{
   ...
   */
  public SupbookRecord(excel.read.biff.SupbookRecord sr, WorkbookSettings ws)
  {
    super(Type.SUPBOOK);
    ...
    {
      System.out.println("Supbook type is addin");
    }
  }
   ...
   */
  private void initInternal(excel.read.biff.SupbookRecord sr)
  {
    numSheets = sr.getNumberOfSheets();
    initInternal();
  }
  ...
  public byte[] getData()
  {
    ...
    {
      System.out.println("unsupported supbook type - defaulting to internal");
      initInternal();
    }
