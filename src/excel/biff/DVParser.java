...
import excel.biff.formula.ParseContext;
...
public class DVParser
{
                  ...
                  WorkbookSettings ws)
  {
    ...
    {
      System.out.println(e.getMessage() + " for cells " + 
  ...
  public DVParser(Collection strings)
  {
    ...
    if (strings.size() == 0)
    {
      System.out.println("no validation strings - ignoring");
    }
    ...
    {
      System.out.println("Validation list exceeds maximum number of characters - " +
                  "truncating");
  ...
  public DVParser(DVParser copy)
  {
    ...
    else
    {
      ...
      {
        System.out.println("Cannot parse validation formula:  " + e.getMessage());
      }
    }
