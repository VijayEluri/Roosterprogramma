...
public class FormattingRecords
{
    ...
    throws NumFormatRecordsException
  {
    ...
    {
      System.out.println("Format index exceeds Excel maximum - assigning custom " +
                  "number");
                                  ...
                                  IndexMapping formatMapping)
  {
    ...
    {
      System.out.println("There are less than the expected minimum number of " +
                   "XF records");
      return mapping;
    }
  ...
  public IndexMapping rationalizeDisplayFormats()
  {
    ...
    while (i.hasNext())
    {
      ...
      if (!duplicate)
      {
        ...
        {
          System.out.println("Too many number formats - using default format.");
