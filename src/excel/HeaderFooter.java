 ...
 */
public final class HeaderFooter extends excel.biff.HeaderFooter
{
  /**
   * The contents - a simple wrapper around a string buffer
   */
  public static class Contents extends excel.biff.HeaderFooter.Contents
  {
    /**
     * The constructor
     */
   ...
   */
  protected excel.biff.HeaderFooter.Contents createContents()
  {
    return new Contents();
  }
   ...
   * @return the created contents
   */
  protected excel.biff.HeaderFooter.Contents createContents(String s)
  {
   ...
   */
  protected excel.biff.HeaderFooter.Contents
    createContents(excel.biff.HeaderFooter.Contents c)
  {
