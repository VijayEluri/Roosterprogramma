...
public final class CellReferenceHelper
{
  ...
  {
    excel.biff.CellReferenceHelper.getCellReference(column, row, buf);
  }
  ...
  public static void getCellReference(int column,
                                      ...
                                      StringBuffer buf)
  {
    excel.biff.CellReferenceHelper.getCellReference(column, colabs,
                                                  row, rowabs,
                                                  buf);
  }
  ...
  {
    return excel.biff.CellReferenceHelper.getCellReference(column, row);
  }
  ...
  {
    return excel.biff.CellReferenceHelper.getColumn(s);
  }
  ...
  {
    return excel.biff.CellReferenceHelper.getColumnReference(c);
  }
  ...
  {
    return excel.biff.CellReferenceHelper.getRow(s);
  }
  ...
  {
    return excel.biff.CellReferenceHelper.isColumnRelative(s);
  }
  ...
  {
    return excel.biff.CellReferenceHelper.isRowRelative(s);
  }
  ...
  {
    excel.biff.CellReferenceHelper.getCellReference
      (sheet, column, row, (excel.biff.formula.ExternalSheet) workbook, buf);
  }
                                       ...
                                       StringBuffer buf)
  {
    excel.biff.CellReferenceHelper.getCellReference
      (sheet, column, colabs, row, rowabs,
       (excel.biff.formula.ExternalSheet) workbook, buf);
  }
  ...
  public static String getCellReference (int sheet,
                                         ...
                                         Workbook workbook)
  {
    return excel.biff.CellReferenceHelper.getCellReference
      (sheet, column, row, (excel.biff.formula.ExternalSheet) workbook);
  }
  ...
  {
    return excel.biff.CellReferenceHelper.getSheet(ref);
  }
