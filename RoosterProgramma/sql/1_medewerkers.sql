...
insert  into `medewerkers`(`id`,`personeelsnummer`,`voornaam`,`achternaam`,`fulltime`,`parttime`,`oproepkracht`,`admin`) values (1,8085,'Joke','Terol',1,0,0,1),(2,2154,'Eveline','Kroon',1,0,0,0);
