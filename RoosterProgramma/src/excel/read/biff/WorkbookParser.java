...
import excel.biff.FontRecord;
import excel.biff.Fonts;
import excel.biff.FormatRecord;
import excel.biff.FormattingRecords;
import excel.biff.NameRangeException;
import excel.biff.NumFormatRecordsException;
import excel.biff.PaletteRecord;
import excel.biff.RangeImpl;
import excel.biff.StringHelper;
  ...
  implements ExternalSheet, WorkbookMethods
{
 ...
 /**
  ...
  public String getExternalSheetName(int index)
  {
    ...
    System.out.println("Unknown Supbook 3");
    return "[UNKNOWN]";
  }
  ...
  public String getLastExternalSheetName(int index)
  {
    ...
    // An unknown supbook - return unkown
    System.out.println("Unknown Supbook 4");
    return "[UNKNOWN]";
  }
  ...
  protected void parse() throws BiffException, PasswordException
  {
    ...
    while (bof != null && getNumberOfSheets() < boundsheets.size())
    {
      ...
      {
        System.out.println("BOF is unrecognized");
    ...
    for (Iterator it = localNames.iterator() ; it.hasNext() ;)
    {
      ...
      {
        System.out.println("Usage of a local non-builtin name");
      } 
