...
class NameRecord extends WritableRecordData
{
  ...
  static class NameRange
  {
    ...
    NameRange(excel.read.biff.NameRecord.NameRange nr)
    {
   ...
   */
  public NameRecord(excel.read.biff.NameRecord sr, int ind)
  {
    super(Type.NAME);
    ...
    // Copy the ranges
    excel.read.biff.NameRecord.NameRange[] r = sr.getRanges();
