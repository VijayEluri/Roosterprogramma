...
/**
 * Abstract class which stores the excel.common.data used for cells, such
  ...
  implements WritableCell
{
  ...
  public void setCellFeatures(WritableCellFeatures cf)
  {
    if (features != null) 
    {
      System.out.println("current cell features for " + 
          ...
          features.getDVParser().extendedCellsValidation())
      {
        ...
        System.out.println("Cannot add cell features to " + 
                    CellReferenceHelper.getCellReference(this) + 
  ...
  public final void addCellFeatures()
  {
    ...
    if (features.hasDataValidation())
    {
      ...
      catch (excel.biff.formula.FormulaException e)
      {
        Assert.verify(false);
      }
