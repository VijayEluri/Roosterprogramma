...
public final class File
{
   ...
   */
  File(OutputStream os, WorkbookSettings ws, excel.read.biff.CompoundFile rcf)
    throws IOException
  {
    outputStream = os;
    workbookSettings = ws;
  ...
  public void setOutputFile(OutputStream os) throws IOException
  {
    if (data != null)
    {
      System.out.println("Rewriting a workbook with non-empty data");
    }
