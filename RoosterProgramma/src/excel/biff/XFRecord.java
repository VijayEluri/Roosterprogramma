...
import excel.format.Format;
import excel.format.Orientation;
import excel.format.Pattern;
import excel.format.VerticalAlignment;
import excel.read.biff.Record;
...
public class XFRecord extends WritableRecordData implements CellFormat
{
  ...
  public XFRecord(Record t, WorkbookSettings ws, BiffType bt)
  {
        ...
        (parentFormat & 0xfff) == 0xfff)
    {
      ...
      parentFormat = 0;
      System.out.println("Invalid parent format found - ignoring");
    }
  ...
  public final void uninitialize()
  {
    ...
    if (initialized == true)
    {
      System.out.println("A default format has been initialized");
    }
    initialized = false;
  }
