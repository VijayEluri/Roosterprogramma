...
import excel.common.LengthUnit;
import excel.common.LengthConverter;

import excel.Image;
import excel.Sheet;
import excel.CellView;
import excel.write.biff.File;
...
public class Drawing implements DrawingGroupObject, Image
{
  ...
  private void initialize()
  {
    ...
    else
    {
      ...
      {
        System.out.println("no filename property for drawing");
    ...
    {
      System.out.println("client anchor not found");
    }
    else
    {
    ...
    if (blipId == 0)
    {
      System.out.println("linked drawings are not supported");
    }
  ...
  private double getWidthInPoints()
  {
    if (sheet == null)
    {
      System.out.println("calculating image width:  sheet is null");
      return 0;
    }
  ...
  private double getHeightInPoints()
  {
    if (sheet == null)
    {
      System.out.println("calculating image height:  sheet is null");
      return 0;
    }
